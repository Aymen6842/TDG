...
Figure~\ref{fig:2-8} presents a high-level entity-relationship diagram showing the main
entities grouped by domain and their key relationships. Attributes are omitted at this stage;
each sprint's class diagrams in Chapter~3 progressively reveal the full detail.

\reportsideways{figures/fig_2_8}{High-level entity-relationship diagram: main entities of the eight domains.}{2-8}

% Flush the sideways ERD page here so Section 2.6 starts after the figure.
\clearpage
