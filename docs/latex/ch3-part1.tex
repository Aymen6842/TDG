...
This chapter describes the five development sprints that built the platform, in the dependency
order fixed by the sprint plan in Section~2.3. Every sprint follows the same structure. It
opens with its goal and backlog, analyses the requirements per module, and presents the UML
design next to the features it describes. It then reports the implementation with screenshots,
validates the deliverables through testing, and closes with a review, a retrospective, and a
cumulative class diagram showing how the domain model grew. The AI sprint, the project's main
technical contribution, is described separately in Chapter~4.
...
\textbf{Difficulties encountered.} This sprint required a lot of learning, as it was the
author's first experience with both NestJS and Prisma. Understanding NestJS's decorator-based
...
not the author, and enqueues the AI index upsert.
