...
which is why the slice shows the relations to \texttt{Task} even though the class itself belongs to
the next module.
...
\reportfigure[\textwidth]{figures/fig_3_21}{Tasks \& Kanban class diagram.}{3-21}
