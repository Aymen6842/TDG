          ...
          <CardContent className="space-y-4 border-t pt-4">
            ...
            <div className="bg-muted rounded-lg p-4">
              ...
              {user && <div className="flex items-center gap-2">
                <code className="bg-background flex-1 rounded px-3 py-2 font-mono text-sm">{user.id}</code>
                <Button variant="outline" size="sm" onClick={() => copyToClipboard({ text: user.id })} className="gap-2 bg-transparent">
                  {copied ? (
                    <>
