...
export default function usePersonalNotificationsSettings(): { settings?: NotificationSettingsType | null, isLoading: boolean, isError: boolean } {
  ...
  useEffect(() => {
    if (user) {
      setSettings({
        emailNotificationsEnabled: user.notificationsSettings.emailNotificationsEnabled,
        telegramNotificationsEnabled: user.notificationsSettings.telegramNotificationsEnabled,
        ntfyNotificationsEnabled: user.notificationsSettings.ntfyNotificationsEnabled,
        pushNotificationsEnabled: user.notificationsSettings.pushNotificationsEnabled,
      });
    }
  }, [user])
