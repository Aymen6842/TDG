          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            <FormField control={form.control} name="email" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder={t("membersList.emailPlaceholder")} {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isPending}>{isPending ? t("membersList.sending") : t("membersList.invite")}</Button>
            </DialogFooter>
          </form>
        </Form>
      </DialogContent>
