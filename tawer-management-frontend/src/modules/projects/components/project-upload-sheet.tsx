...
import UserSearchInput from "@/modules/projects/components/project-detail/members/user-search-combobox";
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 p-4 pt-2">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <TextEditor placeholder={t("upload.form.placeholders.description", { defaultValue: "Describe the project..." })} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            {!isEdit && (
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t("upload.form.labels.manager", { defaultValue: "Manager" })}</FormLabel>
                    <FormControl>
                      <UserSearchInput
                        value={field.value ?? ""}
                        onChange={(userId) => field.onChange(userId)}
                        placeholder={t("upload.form.placeholders.manager", { defaultValue: "Search users..." })}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
