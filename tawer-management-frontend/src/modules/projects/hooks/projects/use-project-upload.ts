...
function buildDefaults(project?: ProjectType | null): ProjectFormValues {
  ...
  return {
    ...
    language: project?.contents?.[0]?.language ?? "English",
    ...
    estimatedStartDate: project?.estimatedStartDate ? new Date(project.estimatedStartDate).toISOString() : start.toISOString(),
    estimatedEndDate: project?.estimatedEndDate ? new Date(project.estimatedEndDate).toISOString() : end.toISOString(),
