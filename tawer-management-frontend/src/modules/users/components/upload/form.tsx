  ...
  useEffect(() => {
    if (user) {
      form.reset({
        ...
        imageUrl: user.image || "",
        emailNotifications: user.notificationsSettings.emailNotificationsEnabled,
        telegramNotifications: user.notificationsSettings.telegramNotificationsEnabled,
        ntfyNotifications: user.notificationsSettings.ntfyNotificationsEnabled,
        telegramChatId: user.notificationsSettings.telegramChatId || ""
      });
    }
  }, [user]);
