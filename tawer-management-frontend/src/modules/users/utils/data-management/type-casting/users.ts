...
export function castToUserType(userInResponse: UserInResponseType): UserType {
  return {
    ...
    notificationsSettings: {
      emailNotificationsEnabled: userInResponse.notificationSettings ? userInResponse.notificationSettings.emailNotificationsEnabled : false,
      telegramNotificationsEnabled: userInResponse.notificationSettings ? userInResponse.notificationSettings.telegramNotificationsEnabled : false,
      ntfyNotificationsEnabled: userInResponse.notificationSettings ? userInResponse.notificationSettings.ntfyNotificationsEnabled : false,
