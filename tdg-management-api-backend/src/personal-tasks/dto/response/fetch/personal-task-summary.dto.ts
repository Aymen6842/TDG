...
export class PersonalTaskSummaryDto {
  @ApiProperty({
  ...
  @Expose()
  @Transform(
    ({ obj }) => (obj as PersonalTaskSummaryDto)?.content?.[0]?.title ?? null,
    {
      toClassOnly: true,
    },
  )
  ...
  @Transform(
    ({ obj }) =>
      (obj as PersonalTaskSummaryDto)?.content?.[0]?.description ?? null,
    {
      toClassOnly: true,
    },
  )
  ...
  @Expose()
  @Transform(
    ({ obj }) => (obj as PersonalTaskSummaryDto)?.content?.[0]?.details ?? null,
    {
      toClassOnly: true,
    },
  )
