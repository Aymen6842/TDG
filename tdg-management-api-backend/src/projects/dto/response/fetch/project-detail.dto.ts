...
import { ProjectInvitationSummaryDto } from './project-invitation-summary.dto';
...
export class ProjectDto {
    ...
    example: [
      {
        ...
        memberName: 'John Doe',
        isManager: true,
        userRoles: ['ScrumMaster', 'SoftwareEngineer'],
  ...
  @ApiProperty({
    ...
    type: [ProjectInvitationSummaryDto],
    example: [
      {
        id: '123e4567-e89b-12d3-a456-426614174002',
        ...
        createdAt: '2025-01-15T10:30:00Z',
        invitedById: '123e4567-e89b-12d3-a456-426614174099',
        isManager: false,
      },
    ],
  })
  @Type(() => ProjectInvitationSummaryDto)
  invitations!: ProjectInvitationSummaryDto[];
  ...
  @Transform(
    ({ obj }: { obj: ProjectWithContents }) => obj.contents?.[0]?.name ?? '',
    { toClassOnly: true },
  )
  name!: string;
